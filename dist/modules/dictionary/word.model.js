...
var kanji_model_1 = require("../kanji/kanji.model");
...
WordSchema.pre('remove', function (next) {
    var word = this;
    kanji_model_1.default.update({ dictionary: word._id }, { $pull: { dictionary: word._id } }).exec();
    next();
});
WordSchema.methods = {
    toJSON: function () {
...
WordSchema.statics = {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        word = _a.sent();
                        return [4 /*yield*/, this.findById(word._id).populate('abrev')];
    ...
    list: function (query) {
        var result = this.find()
            ...
            .populate('abrev');
        if (query.letter)
            result = result.find({ word: { $regex: query.letter } });
        if (query.count)
            result = result.count();
        return result;
    },
